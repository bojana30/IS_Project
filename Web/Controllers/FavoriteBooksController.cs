...
namespace Web.Controllers
{
    public class FavoriteBooksController : Controller
    {
        ...
        public FavoriteBooksController(IFavoriteBookService favoriteBookService)
        {
        ...
        public IActionResult Index()
        {
            ...
            var favorites = _favoriteBookService.GetFavoritesForUser(userId);

            return View(favorites);
        }

        // POST: FavoriteBooks/Add
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Add(Guid bookId)
        {
            ...
            _favoriteBookService.AddToFavorites(userId, bookId);

            return RedirectToAction("Details", "Books", new { id = bookId });
        }

        // POST: FavoriteBooks/Remove
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Remove(Guid bookId)
        {
            ...
            _favoriteBookService.RemoveFromFavorites(userId, bookId);
